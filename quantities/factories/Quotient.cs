...
public interface IQuotientFactory<TNominator, TDenominator> : IFactory
...
public readonly struct Quotient<TCreate, TQuantity, TNominator, TDenominator> : ICompoundFactory<Denominator<TCreate, TQuantity, TDenominator>, TNominator>, IQuotientFactory<TNominator, TDenominator>
    where TQuantity : IFactory<TQuantity>
    where TCreate : struct, ICreate
    where TNominator : IDimension, ILinear
    where TDenominator : IDimension, ILinear
