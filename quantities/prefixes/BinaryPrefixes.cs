...
public readonly struct Mebi : IBinaryPrefix, IScaleUp
{
    ...
    static Transformation ITransform.ToSi(Transformation self) => Binary.Base * self.With<Kibi>();
...
public readonly struct Gibi : IBinaryPrefix, IScaleUp
{
    ...
    static Transformation ITransform.ToSi(Transformation self) => Binary.Base * self.With<Mebi>();
...
public readonly struct Tebi : IBinaryPrefix, IScaleUp
{
    ...
    static Transformation ITransform.ToSi(Transformation self) => Binary.Base * self.With<Gibi>();
...
public readonly struct Pebi : IBinaryPrefix, IScaleUp
{
    ...
    static Transformation ITransform.ToSi(Transformation self) => Binary.Base * self.With<Tebi>();
...
public readonly struct Exbi : IBinaryPrefix, IScaleUp
{
    ...
    static Transformation ITransform.ToSi(Transformation self) => Binary.Base * self.With<Pebi>();
...
public readonly struct Zebi : IBinaryPrefix, IScaleUp
{
    ...
    static Transformation ITransform.ToSi(Transformation self) => Binary.Base * self.With<Exbi>();
...
public readonly struct Yobi : IBinaryPrefix, IScaleUp
{
    ...
    static Transformation ITransform.ToSi(Transformation self) => Binary.Base * self.With<Zebi>();
