...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e30 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e27 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e24 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e21 * value;
    static String IRepresentable.Representation => "Z";
}
[DebuggerDisplay(nameof(Exa))]
public readonly struct Exa : IMetricPrefix, IScaleUp
{
    static Transformation ITransform.ToSi(Transformation value) => 1e18 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e15 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e12 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e9 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e6 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e3 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e2 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => 1e1 * value;
...
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e1;
...
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e2;
...
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e3;
    static String IRepresentable.Representation => "m";
}
[DebuggerDisplay(nameof(Micro))]
public readonly struct Micro : IMetricPrefix, IScaleDown
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e6;
...
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e9;
...
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e12;
    static String IRepresentable.Representation => "p";
}
[DebuggerDisplay(nameof(Femto))]
public readonly struct Femto : IMetricPrefix, IScaleDown
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e15;
...
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e18;
...
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e21;
    static String IRepresentable.Representation => "z";
}
[DebuggerDisplay(nameof(Yocto))]
public readonly struct Yocto : IMetricPrefix, IScaleDown
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e24;
    static String IRepresentable.Representation => "y";
}
[DebuggerDisplay(nameof(Ronto))]
public readonly struct Ronto : IMetricPrefix, IScaleDown
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e27;
    static String IRepresentable.Representation => "r";
}
[DebuggerDisplay(nameof(Quecto))]
public readonly struct Quecto : IMetricPrefix, IScaleDown
{
    static Transformation ITransform.ToSi(Transformation value) => value / 1e30;
    static String IRepresentable.Representation => "q";
}
