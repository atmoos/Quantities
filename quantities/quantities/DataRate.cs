    ...
    , IMultiplyOperators<DataRate, Time, Data>
{
    ...
    internal static DataRate From(in Data data, in Time time) => new(data.Value.Divide(time.Value));
    ...
    public static Double operator /(DataRate left, DataRate right) => left.dataRate / right.dataRate;
