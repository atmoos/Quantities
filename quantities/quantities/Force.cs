    ...
    , IMultiplyOperators<Force, Velocity, Power>
{
    ...
    {
        return new(MetricPrefix.ScaleThree(power.Value.SiDivide(velocity.Value), root));
    }
    ...
    public static Double operator /(Force left, Force right) => left.force / right.force;
