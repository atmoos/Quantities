...
internal static class Deserialization
{
    ...
    public static Create Find(String system, String? prefix, String unit)
    {
    ...
    {
        var genericMethod = typeof(Deserialization).GetMethod(name, typeArgumentCount, BindingFlags.Static | BindingFlags.NonPublic, null, CallingConventions.Standard, Type.EmptyTypes, null);
