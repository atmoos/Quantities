...
public static class Convenience
{
    ...
    public static T Deserialize<T>(this String value, JsonSerializerOptions options) =>
        JsonSerializer.Deserialize<T>(value, options) ?? throw new Exception($"Deserialization of {typeof(T).Name} failed");
}
