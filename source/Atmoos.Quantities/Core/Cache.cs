    ...
    where TValue : notnull
{
    ...
    public TValue this[in TKey key, Create<TKey, TValue> create] => this.cache.TryGetValue(key, out var value) ? value : this.cache[key] = create(key);
    ...
    where TValue : notnull
{
    ...
    public TValue this[TKeyOne firstKey, TKeyTwo secondKey, Create<TKeyOne, TKeyTwo, TValue> create] => this.Get(firstKey, secondKey, create, (f, s, c) => c(f, s));
