...
public static class Systems
{
    ...
    public static Creation.Power<TUnit, Two> Square<TUnit>(in Scalar<TUnit> scalar)
        where TUnit : IUnit, ILinear, IDimension => new(scalar.Factory);

    public static Creation.Power<TUnit, Three> Cubic<TUnit>(in Scalar<TUnit> scalar)
        where TUnit : IUnit, ILinear, IDimension => new(scalar.Factory);
}
