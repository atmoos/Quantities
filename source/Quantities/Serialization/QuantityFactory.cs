    ...
    where TQuantity : IFactory<TQuantity>
{
    ...
    private QuantityFactory(IInject injector, UnitRepository repository, params Type[] verifications) : this()
    {
    ...
    private static IBuilder Create(UnitRepository repo, in QuantityModel model, Type verification, IInject injector)
    {
    ...
    private static IBuilder Create(UnitRepository repo, QuantityModel[] models, Type[] verifications, IInject injector)
    {
