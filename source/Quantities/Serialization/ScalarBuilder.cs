...
internal static class ScalarBuilder
{
    ...
    private static Creator CreateSiAlias<TSi, TDim>() where TSi : ISiUnit, IDim, IAlias<TDim> where TDim : IDim, ILinear => i => AliasInjector<TSi, TDim>(i).Inject<Si<TSi>>();
    ...
    private static Creator CreateSiAlias<TPrefix, TSi, TDim>() where TPrefix : IPrefix where TSi : ISiUnit, IDim, IAlias<TDim> where TDim : IDim, ILinear => i => AliasInjector<TSi, TDim>(i).Inject<Si<TPrefix, TSi>>();
    ...
    private static Creator CreateMetricAlias<TMetric, TDim>() where TMetric : IMetricUnit, IDim, IAlias<TDim> where TDim : IDim, ILinear => i => AliasInjector<TMetric, TDim>(i).Inject<Metric<TMetric>>();
    ...
    private static Creator CreateMetricAlias<TPrefix, TMetric, TDim>() where TPrefix : IPrefix where TMetric : IMetricUnit, IDim, IAlias<TDim> where TDim : IDim, ILinear => i => AliasInjector<TMetric, TDim>(i).Inject<Metric<TPrefix, TMetric>>();
    ...
    private static Creator CreateImperialAlias<TImperial, TDim>() where TImperial : IImperialUnit, IDim, IAlias<TDim> where TDim : IDim, ILinear => i => AliasInjector<TImperial, TDim>(i).Inject<Imperial<TImperial>>();
    ...
    private static Creator CreateNonStandardAlias<TNonStandard, TDim>() where TNonStandard : INonStandardUnit, IDim, IAlias<TDim> where TDim : IDim, ILinear => i => AliasInjector<TNonStandard, TDim>(i).Inject<NonStandard<TNonStandard>>();
    ...
    private static IInject<IBuilder> AliasInjector<TUnit, TDim>(IInject<IBuilder> injector)
        where TDim : IDim, ILinear where TUnit : IAlias<TDim> => TUnit.Inject(new InjectorFactory<AliasCreator, TDim>(injector));
